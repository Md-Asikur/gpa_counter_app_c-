...
namespace ConsoleApp8
{
    internal class Program
    {
        ...
        public static double PromtGrades()
        {
            ...
            /* Console.WriteLine("Enter Your Credit for BusinessBook"); ;//2
            int businessCredit = Convert.ToInt32(Console.ReadLine());*/
            int dataCredit = 4;//4
            int algorithmCredit = 4;//3
            int electCreditt = 2;//4
            int peripherialsCredit = 2;//3
            int webCredit = 2;//2
            int objCredit = 4;//3

            double totalpoints = 0;
            Console.WriteLine("Enter Your Grade for BusinessBook");
            string Businnness = Console.ReadLine();  //for switch case
            //int Businnness = Convert.ToInt32(Console.ReadLine()); //for if else statements
            ...
            return totalpoints;
            //double sumCredit = businessCredit + dataCredit + electCreditt + algorithmCredit + peripherialsCredit + webCredit + objCredit;
